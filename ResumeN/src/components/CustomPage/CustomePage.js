            ...
            <div  id="customPage" className="custom-page">
                ...
                <div className="custom-page__nav">
                    ...
                    <ul className="custom-page__navlinks">
                        <li>
                            <Link  className="custom-page__navlinks" to={{pathname:"/"}}>Home</Link>
                        </li>
                        {this.state.pages.map((value, index) => {
                                return <li key={index}>  <a className="custom-page__navlinks"  href={"./" + value.id}>{value.id}</a>  </li>
                            })}
                    ...
                    <div className="custom-page__footer" >
                        ...
                        <div className="custom-page__footer-item">
                            ...
                            <ul className="custom-page__footer-item__website-links">
                                <li><a href="/">Home</a></li>
                                {this.state.pages.map((value, index) => {
                                    return <li key={index}><a href={'/p/' + value.id}>{value.id}</a></li>
                                })}
                            </ul>
                        </div>
                        {/* Footer Item */}
