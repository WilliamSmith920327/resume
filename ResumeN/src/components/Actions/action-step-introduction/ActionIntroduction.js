          ...
          <div className="authentication">
            {
              this.props.user != null ?
                <Link style={{ textDecoration: "none" }} to={{ pathname: "./dashboard" }} className="authenticationButton">  {t("selectionAction.account")}</Link>
                :
                <a onClick={() => this.props.authBtnHandler()} className="authenticationButton">  {t("intro.login")} </a>
            }
            {this.props.values.email == conf.adminEmail &&     <Link style={{ textDecoration: "none" }} className="authenticationButton"  to={{ pathname: "./adm/dashboard" }} className="authenticationButton">  {t("selectionAction.admin")}</Link>}
           ...
           <div className="footer">
            <ul>
              ...
              {this.state.pages !== null && this.state.pages.map((value, index) => {
                            return <li>  <Link  to={{ pathname: "/p/" + value.id }}>{value.id}</Link>  </li>
